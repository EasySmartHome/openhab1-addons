...
public class Mail {
    ...
    public static boolean send(String id, String username, String password, String to, String subject, String message) {
        ...
        NameValuePair[] data = { new NameValuePair("action", "email"), new NameValuePair("cmId", id),
                new NameValuePair("cmUsername", username), new NameValuePair("cmPassword", password),
                new NameValuePair("subject", subject), new NameValuePair("to", to), new NameValuePair("body", message),
